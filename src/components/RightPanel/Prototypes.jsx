  ...
  return (
        <section id="xr prototypes">
          <CardGroup title="XR Prototypes">
            ...
            <Card
              title="FaceTrackAR - Face Mapper"
              description="FaceTrackAR is a lightweight OpenCV demo that reads live facial landmarks and maps expressions to an avatar in real time. It tracks smiles, blinks, eyebrow raises, with simple smoothing to keep motion stable. Quick to set up and fun to use, it’s a handy building block for streaming overlays or MR prototypes."
